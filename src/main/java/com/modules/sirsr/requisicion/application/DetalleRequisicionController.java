...
public class DetalleRequisicionController {
	...
	public DetalleRequisicionController(RequisicionService requisicionService,
			DetalleRequisicionService detalleRequisicionService, ProductoService productoService,
	...
	public String editar(@PathVariable("id") int id, Model model) {
		...
		String objetoGasto = detalleRequisicionDTO.getRequisicion().getClavePresupuestaria().getObjetoDeGasto()
				.getObjetoGasto();
		productos = productoService.findByIdTipoProducto(objetoGasto);
