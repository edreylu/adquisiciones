package com.modules.sirsr.tipoPersonaFiscal.infrastructure;
...
import com.modules.sirsr.tipoPersonaFiscal.application.TipoPersonaFiscalService;
...
public class TipoPersonaFiscalController {
    ...
    public String editar(@PathVariable("id") int id, TipoPersonaFiscalDTO tipopersonafiscal, RedirectAttributes redirectAttrs) {
