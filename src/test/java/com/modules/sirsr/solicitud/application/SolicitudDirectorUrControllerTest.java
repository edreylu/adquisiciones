...
@WebMvcTest(SolicitudDirectorUrController.class)
public class SolicitudDirectorUrControllerTest {
	...
	@Test
	public void itShouldListAllSolicitudesDirectorUr() throws Exception {
		...
		// then
		this.mockMvc
				.perform(get("/directorur/solicitudes").with(csrf())
						.with(SecurityMockMvcRequestPostProcessors.user("ADMIN").roles("DIRECTORUR")))
				//.andDo(print())
				.andExpect(status().isOk()).andExpect(view().name("directorur/solicitudes/principal"))
	...
	@Test
	public void itShouldShowsDetailsSolicitudDirectorUr() throws Exception {
		...
		// then
		this.mockMvc
				.perform(get("/directorur/solicitudes/revisar/{id}", solicitud.getIdSolicitud()).with(csrf())
						.with(SecurityMockMvcRequestPostProcessors.user("ADMIN").roles("DIRECTORUR")))
				// .andDo(print())
				...
				.andExpect(view().name("directorur/solicitudes/revisar"));
	}

	@Test
	public void canEmitirSolicitudDirectorUr() throws Exception {
		...
		// then
		this.mockMvc
				.perform(post("/directorur/solicitudes/emitir/{id}", solicitud.getIdSolicitud()).with(csrf())
						.with(SecurityMockMvcRequestPostProcessors.user("ADMIN").roles("DIRECTORUR")))
				// .andDo(print())
				.andExpect(flash().attribute("clase", "success"))
				.andExpect(view().name("redirect:/directorur/solicitudes"))
				.andExpect(status().isFound())
				.andExpect(header().string("Location", "/directorur/solicitudes"));
	}

	@Test
	public void itShouldReturnsDetallesRequisicionDirectorUr() throws Exception {
		...
		// then
		this.mockMvc
				.perform(get("/directorur/solicitudes/searchDetallesRequisicion/{id}", requisicion.getIdRequisicion())
						.with(csrf()).with(SecurityMockMvcRequestPostProcessors.user("ADMIN").roles("ADMIN", "DIRECTORUR")))
				// .andDo(print())
				.andExpect(status().isOk())
				.andExpect(view().name("directorur/solicitudes/revisar :: modalDetalles"))
	...
	@Test
	void itShouldFindRevisionesDirectorUr() throws Exception {
		...
		// then
		this.mockMvc
				.perform(get("/directorur/solicitudes/searchObservaciones/{id}", solicitud.getIdSolicitud()).with(csrf())
						.with(SecurityMockMvcRequestPostProcessors.user("ADMIN").roles("DIRECTORUR")))
				// .andDo(print())
				.andExpect(status().isOk())
				.andExpect(view().name("directorur/solicitudes/revisar :: modalObservaciones"))
